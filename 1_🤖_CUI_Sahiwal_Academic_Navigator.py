...
def main():
    ...
    st.markdown("<br><br><h3 style='text-align:center; font-size:30px; font-weight:1000;'>Explore More</h3><h3 style='text-align:center;'>⬇️</h3><br><br><br><br>", unsafe_allow_html=True)
