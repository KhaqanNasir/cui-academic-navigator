...
# def generate_solid_color_images(image):
#     images = []
#     for _ in range(10):
#         color = tuple(random.choices(range(50, 256), k=3))  # Dynamic random RGB values
#         bg = Image.new("RGBA", image.size, color)
#         combined = Image.alpha_composite(bg, image.convert("RGBA"))
...
#     images = []
#     for _ in range(count):  # Generate 'count' gradient images
...
#         combined = Image.alpha_composite(gradient.convert("RGBA"), image.convert("RGBA"))
#         images.append(combined.convert("RGB"))
#     return images

# # Function to generate RGB images
# def generate_rgb_images(image):
#     images = []
#     for _ in range(20):  # Generate 20 RGB images
...
#             solid_color_images = generate_solid_color_images(processed_image)
#             gradient_images = generate_gradient_images(processed_image, count=20)  # 20 gradient images
#             rgb_images = generate_rgb_images(processed_image)

#             # Save images to output directory
#             all_images = solid_color_images + gradient_images + rgb_images
#             for idx, img in enumerate(all_images):
#                 img.save(f"{output_dir}/profile_{idx+1}.jpg", "JPEG")
